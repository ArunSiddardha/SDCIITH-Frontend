...
function Team() {
  return (
    ...
    <ul className='text-[1.1rem] text-md md:text-lg mb-5 text-[#3B454E]'>
        <li >
    ...
    <ul className='list-disc text-md md:text-lg text-[#3B454E] m-4'>
      <li>Cheif Members</li>
    ...
    <div className='text-center text-[1.4rem] text-[#3B454E]  font-bold'>CHEIF MEMBERS</div>
    ...
    <ul className='text-[1rem] text-md md:text-lg text-[#3B454E]'>
       ...
       <li className='m-2'> <strong>Design Maester:</strong> He/She is the Backbone of SDC's Design council.He/She manages and guides the design council to create beautiful UIs and stunning UX for the projects of SDC. </li>
    </ul>
    <div className='text-xl text-[#3B454E] font-bold my-5 mb-2 '>Commanders (Mentors)</div>
    <ul className='text-md md:text-lg text-[#3B454E] mb-8 text-[#3B454E]'>
    ...
    <div className='text-center text-[1.4rem] text-[#3B454E]  font-bold'>SUPPORTING MEMBERS</div>
